...
function getVariableSpec (spec, variables) {
...
Api.prototype.addPodSpecs = function (plugin, podSpecs, frameworkPods, installOptions) {
    ...
    if (podSpecs.length) {
        ...
        podSpecs.forEach(function (obj) {
            ...
            Object.keys(obj.libraries).forEach(function (key) {
                ...
                if (podJson.spec) {
                    podJson.spec = getVariableSpec(podJson.spec, installOptions.variables);
                }
    ...
    if (frameworkPods.length) {
        ...
        frameworkPods.forEach(function (obj) {
            const spec = getVariableSpec(obj.spec, installOptions.variables);
            const podJson = {
                name: obj.src,
                type: obj.type,
                spec
...
Api.prototype.removePodSpecs = function (plugin, podSpecs, frameworkPods, uninstallOptions) {
    ...
    if (podSpecs.length) {
        ...
        podSpecs.forEach(function (obj) {
            ...
            Object.keys(obj.libraries).forEach(function (key) {
                const podJson = Object.assign({}, obj.libraries[key]);
                if (podJson.spec) {
                    podJson.spec = getVariableSpec(podJson.spec, uninstallOptions.cli_variables);
                }
                const val = podsjsonFile.getLibrary(key);
                if (val) {
    ...
    if (frameworkPods.length) {
        ...
        frameworkPods.forEach(function (obj) {
            const spec = getVariableSpec(obj.spec, uninstallOptions.cli_variables);
            const podJson = {
                name: obj.src,
                type: obj.type,
                spec
